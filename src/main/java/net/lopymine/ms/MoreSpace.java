...
public class MoreSpace implements ModInitializer {

	public static final String MOD_NAME = /*$ mod_name*/ "More Space";
	public static final String MOD_ID = /*$ mod_id*/ "more-space";
