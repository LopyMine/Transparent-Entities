...
public class EquipmentRendererMixin {
	...
	private RenderLayer renderTransparencyArmorParts(Identifier identifier, Operation<RenderLayer> original, @Local(argsOnly = true) LayerType layerType) {
		return TransparencyLayers.getLayerNoCull(layerType, identifier, () -> original.call(identifier));
	}
